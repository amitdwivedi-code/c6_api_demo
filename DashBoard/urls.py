...
urlpatterns = [
    ...
    path('fuel_distribution_dashboard/', views.Fuel_Distribution_Dashboard.as_view(), name='get_fuel_distribution_summery'),
    path('scope2_emission_dashboard/',views.Scope2_Emission_Dashboard.as_view(), name='scope2_emission_dashboard'),
