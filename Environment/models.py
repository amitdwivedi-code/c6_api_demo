...
class Waste_Generated(models.Model):
    ...
    Facility = models.CharField(max_length=200, blank=True, null=True)
    Type = models.CharField(max_length=200, blank=True, null=True)
    Waste_Generated_Apr = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_May = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Jun = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Jul = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Aug = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Sep = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Oct = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Nov = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Dec = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Jan = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Feb = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Mar = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
    Waste_Generated_Total = models.DecimalField(decimal_places=2,max_digits=50,blank=True, null=True)
